...
public class Blockchain extends JFrame {
	...
	public Blockchain() {
		...
		transactionNum = 1; // come back and look at it.
		
		//initialize an array of names
		String[] names = {"Charley", "Devin", "Bob", "Alice"};
		...
		signBtn.addActionListener(new ActionListener()
		{
			...
			public void actionPerformed(ActionEvent e)
			{
				...
				String tran = (transactionNum + payerCombo.getSelectedItem().toString() + paidCombo.getSelectedItem().toString() + txtAmount.getText());
				...
				boolean verify = DigitalSignature.verifySignature(tran);
				listModel.addElement(tran + " " + verify);		
